$(document).ready(function (){
	...
	function titleClickedResult (apiResult) { //carica il contenuto della pagina wikipedia sul nostro sito
		...
		$('#toc a').click(function(e){//FRAMMENTO MAGICO E DALLA DUBBITA UTILITÁ, PERMETTE ALL INDICE DI FUNZIONARE IN CAMBIO DI UN ERRORE, DA SISTEMARE....
		
				/*if ( window.history.replaceState ) {
					var toca = $(this).attr('href');
